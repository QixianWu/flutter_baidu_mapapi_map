...
class OfflineController {
  ...
  void onGetOfflineMapStateBack(
    ...
    if (_bmfGetOfflineMapStateback != null || callback == null) { // ignore: unnecessary_null_comparison
      return;
    }
  ...
  Future<dynamic> _handlerMethod(MethodCall call) async {
    ...
    if (null == method || null == this._bmfGetOfflineMapStateback) { // ignore: unnecessary_null_comparison
      return;
    }
