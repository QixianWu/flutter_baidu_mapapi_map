...
class BMFUserLocation implements BMFModel {
  ...
  BMFUserLocation.fromMap(Map map)
    ...
    location = map['location'] == null ? null : BMFLocation.fromMap(map['location']);
    heading = map['heading'] == null ? null : BMFHeading.fromMap(map['heading']);
    title = map['title'];
...
class BMFUserLocationDisplayParam implements BMFModel {
  ...
  BMFUserLocationDisplayParam.fromMap(Map map)
    ...
    userTrackingMode = BMFUserTrackingMode.values[map['userTrackingMode'] as int];
    ...
    locationViewHierarchy = BMFLocationViewHierarchy.values[map['locationViewHierarchy'] as int];
  }
