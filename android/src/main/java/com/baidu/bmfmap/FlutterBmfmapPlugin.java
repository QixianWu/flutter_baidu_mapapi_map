...
public class FlutterBmfmapPlugin implements FlutterPlugin, ActivityAware,
    ...
    // This static functions is optional and equivalent to onAttachedToEngine. It supports the old
    // pre-Flutter-1.12 Android projects. You are encouraged to continue supporting
    // plugin registration via this functions while apps migrate to use the new Android APIs
